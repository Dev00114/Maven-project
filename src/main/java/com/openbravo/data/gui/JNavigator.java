...
public class JNavigator extends javax.swing.JPanel implements BrowseListener, StateListener {
    ...
    private com.openbravo.beans.JImageButton jbtnFind = null;
    private com.openbravo.beans.JImageButton jbtnSort = null;
    private com.openbravo.beans.JImageButton jbtnFirst = null;
    private com.openbravo.beans.JImageButton jbtnLast = null;
    private com.openbravo.beans.JImageButton jbtnNext = null;
    private com.openbravo.beans.JImageButton jbtnPrev = null;
    private com.openbravo.beans.JImageButton jbtnRefresh = null;
    private com.openbravo.beans.JImageButton jbtnReload = null;    
    ...
    public JNavigator(BrowsableEditableData bd, Vectorer vec, ComparatorCreator cc, int iButtons) {
        ...
        if (iButtons == BUTTONS_ALL) {
            jbtnFirst = new com.openbravo.beans.JImageButton();
            jbtnFirst.setPreferredSize(new java.awt.Dimension(60,60));
            ...
            jbtnFirst.setIconPrefix("double-left");
        ...
        if (iButtons == BUTTONS_ALL) {
            jbtnPrev = new com.openbravo.beans.JImageButton();
            jbtnPrev.setPreferredSize(new java.awt.Dimension(60,60));            
            ...
            jbtnPrev.setIconPrefix("single-left");
        ...
        jbtnRefresh = new com.openbravo.beans.JImageButton();
        jbtnRefresh.setPreferredSize(new java.awt.Dimension(60,60));        
        ...
        jbtnRefresh.setIconPrefix("single-down");
        ...
        if (iButtons == BUTTONS_ALL) {
            jbtnNext = new com.openbravo.beans.JImageButton();
            jbtnNext.setPreferredSize(new java.awt.Dimension(60,60));            
            ...
            jbtnNext.setIconPrefix("single-right");
        ...
        if (iButtons == BUTTONS_ALL) {
            jbtnLast = new com.openbravo.beans.JImageButton();
            jbtnLast.setPreferredSize(new java.awt.Dimension(60,60));            
            ...
            jbtnLast.setIconPrefix("double-right");
        ...
        if (bd.canLoadData()) {
            jbtnReload = new com.openbravo.beans.JImageButton();
            jbtnReload.setPreferredSize(new java.awt.Dimension(60,60));            
        ...
        if (vec == null) {
            ...
            jbtnFind = new com.openbravo.beans.JImageButton();
            jbtnFind.setPreferredSize(new java.awt.Dimension(60,60));            
        ...
        m_cc = cc;
        if (m_cc != null) {
            jbtnSort = new com.openbravo.beans.JImageButton();
            jbtnSort.setPreferredSize(new java.awt.Dimension(60,60));            
