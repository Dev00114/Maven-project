...
public class JPrincipalApp extends javax.swing.JPanel implements AppUserView {
  ...
  public JPrincipalApp(JRootApp appview, AppUser appuser) {
    ...
    m_jPanelLeft.getVerticalScrollBar().setPreferredSize(new Dimension(8, 8));
    ...
    try {
      ...
      delegate.setOpenIcon(menu_open);
      delegate.setCloseIcon(menu_close);
  }
  ...
  private void assignMenuButtonIcon() {
    jButton1.setIconPrefix(m_jPanelLeft.isVisible()
            ? "single-left-48"
            : "single-right-48");
  }
  ...
  private void showView(String sView) {
    System.out.println("JPrrincipalApp showView ==> sView line 438"+sView);

    if(sView == "com.openbravo.pos.sales.JPanelTicketSales" || 
            sView == "com.openbravo.pos.sales.JPanelTicketEdits" ||
            sView == "com.openbravo.pos.customers.CustomersPayment")
   ...
   */
    ...
    private void initComponents() {
        ...
        jButton1.setIconPrefix("single-right-48");
        ...
        m_jPanelContainer.setOpaque(false);
  ...
  public boolean jBtnMenuActionPerformed()
  {
      setMenuVisible(!m_jPanelLeft.isVisible());
      return m_jPanelLeft.isVisible();
  }
