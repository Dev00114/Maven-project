...
//        }
    ...
    public final ProductInfoExt getProductInfoByShortCode(String sCode) throws BasicException {
        ...
        return (ProductInfoExt) new PreparedSentence(s, "SELECT "
                ...
                + "MEMODATE "
                + "FROM products "
                + "WHERE SUBSTRING( CODE, 3, 6 ) = ?", SerializerWriteString.INSTANCE, ProductInfoExt.getSerializerRead()).find(sCode.substring(2, 8));
    }
     ...
     */
    public final List<CategoryInfo> getRootCategories(String sub) throws BasicException {
        return new PreparedSentence(s, "SELECT "
                ...
                + ( ! sub.equals("") ? " AND ID != '"+sub+"' " : " ")
                
                + "ORDER BY " + (! sub.equals("") ? "CATORDER, NAME" : "ID, NAME, CATORDER")
...
//     * @return @throws BasicException
//     */
//    public final List<CategoryInfo> getCategoriesFromId(String subproduct_id) throws BasicException {
//        
//        return new PreparedSentence(s, "SELECT "
//                + "categories.ID, "
//                + "NAME, "
...
//                + "CATSHOWNAME, "
//                + "CATORDER "
//                + "FROM product_cats JOIN categories ON (product_cats.CATEGORY = categories.ID)"
//                + "WHERE PARENTID IS NULL AND CATSHOWNAME = " + s.DB.TRUE() + " AND SUBPRODUCT = '" + subproduct_id +"' "
...
//    }
    ...
    public final List<CategoryInfo> getSubcategories(String category) throws BasicException {
        return new PreparedSentence(s, "SELECT "
                ...
                + "ORDER BY CATORDER, NAME", SerializerWriteString.INSTANCE, CategoryInfo.getSerializerRead()).list(category);
    }
    ...
    public List getProductCatalog(String category) throws BasicException {
        return new PreparedSentence(s, "SELECT "
                ...
                + "WHERE P.ISCOM = '0' AND P.ID = O.PRODUCT AND P.CATEGORY = ? "
                + "ORDER BY O.CATORDER, P.NAME ", SerializerWriteString.INSTANCE, ProductInfoExt.getSerializerRead()).list(category);
        
    }
    
    public final List getProductByCat(String category) throws BasicException {
        return new StaticSentence(s, 
                ...
                + "ORDER BY P.REFERENCE",
                 new String[]{
                    ...
                    Datas.OBJECT, Datas.STRING,
                    Datas.OBJECT, Datas.STRING}),
                    productsRow.getSerializerRead()).list((Object) null);
        
//        new SerializerReadClass(ReprintTicketInfo.class)
    }
    ...
    public List<ProductInfoExt> getDefaultProductComments(String cat_id) throws BasicException {
        return new PreparedSentence(s, "SELECT "
                + "P.ID, "
                + "P.REFERENCE, "
                + "P.CODE, "
                ...
                + "P.UOM, "
                + "P.MEMODATE "
                + "FROM product_cats JOIN products P ON (product_cats.SUBPRODUCT = P.ID)"
                + "WHERE product_cats.CATEGORY = ? "
                + "AND P.ISCOM = " + s.DB.TRUE() + " "
                + "ORDER BY P.NAME", SerializerWriteString.INSTANCE, ProductInfoExt.getSerializerRead()).list(cat_id);
    }
    
    public void setSubProducts(String main_id, List<ProductInfoExt> subs) throws BasicException {
        
        String sql = "DELETE FROM products_com WHERE PRODUCT='"+main_id + "'";
        SentenceExec remover = new PreparedSentence(s, sql, SerializerWriteParams.INSTANCE);
        remover.exec(new DataParams() {
            @Override
        ...
        if(subs.size() > 0 ) {
            ...
            SentenceExec insert = new PreparedSentence(s, sql, SerializerWriteParams.INSTANCE);

            insert.exec(new DataParams() {
                @Override
                public void writeValues() throws BasicException {
                }
            });
    ...
    public List<ProductInfoExt> getSubsByProduct(String product_id)  throws BasicException {
        return new PreparedSentence(s, "SELECT "
                + "P.ID, "
                + "P.REFERENCE, "
                + "P.CODE, "
                ...
                + "P.UOM, "
                + "P.MEMODATE "
                + "FROM products_com M JOIN products P ON (M.PRODUCT2 = P.ID)"
                + "WHERE M.PRODUCT = ? "
                + "ORDER BY P.NAME", SerializerWriteString.INSTANCE, ProductInfoExt.getSerializerRead()).list(product_id);
    }
    
    public List<ProductInfoExt> getAllSubs(String cat_id) throws BasicException {
        return new PreparedSentence(s, "SELECT "
                + "P.ID, "
                + "P.REFERENCE, "
                + "P.CODE, "
    ...
    public final CategoryInfo getCategoryInfo(String id) throws BasicException {
        return (CategoryInfo) new PreparedSentence(s, "SELECT "
                ...
                + "FROM categories "
                + "WHERE ID = ? "
                + "ORDER BY CATORDER, NAME", SerializerWriteString.INSTANCE, CategoryInfo.getSerializerRead()).find(id);
    }
    ...
    public SentenceList getProductList2() {
        return new StaticSentence(s, new QBFBuilder(
                ...
                new String[]{"NAME", "UNITS", "SellIncTax", "LOCATION",}), new SerializerWriteBasic(new Datas[]{
                    Datas.OBJECT, Datas.STRING,
                    Datas.OBJECT, Datas.DOUBLE,
                    Datas.OBJECT, Datas.DOUBLE,
                    Datas.OBJECT, Datas.STRING}), ProductInfoExt.getSerializerRead());
    ...
    public final ProductStock getProductStockState(String pId, String location) throws BasicException {
        ...
        PreparedSentence preparedSentence = new PreparedSentence(s,
                ...
                + "WHERE products.id = ? "
                + "AND locations.id = ?", SerializerWriteString.INSTANCE, ProductStock.getSerializerRead());
    ...
    public final List<ReprintTicketInfo> getReprintTicketList() throws BasicException {
        ...
        //payment queries
        List<ReprintTicketInfo> ticketInfoList = (List<ReprintTicketInfo>) new StaticSentence(s, "SELECT "
                + "T.TICKETID, "
                + "T.TICKETTYPE, "
                + "R.DATENEW, "
                + "P.NAME, "
                ...
                + "LIMIT 10 ", null, new SerializerReadClass(ReprintTicketInfo.class)).list();
    ...
    public final TicketInfo getReprintTicket(String Id) throws BasicException {
        ...
        if (Id == null) {
            ...
            Object[] record = (Object[]) new StaticSentence(s, "SELECT "
                    ...
                    + "ON R.ID = PM.RECEIPT LEFT OUTER JOIN customers C "
                    + "ON C.ID = T.CUSTOMER LEFT OUTER JOIN people P ON T.PERSON = P.ID "
                    + "WHERE T.TICKETID = ?", SerializerWriteString.INSTANCE, new SerializerReadBasic(new Datas[]{Datas.SERIALIZABLE})).find(Id);
    ...
    public SentenceList getTicketsList() {
        ...
        StaticSentence staticSentence = new StaticSentence(s, new QBFBuilder(
                "SELECT "
                + "T.TICKETID, "
                + "T.TICKETTYPE, "
                + "R.DATENEW, "
                ...
                + "ORDER BY R.DATENEW DESC, T.TICKETID",
                new String[]{
                    "T.TICKETID", "T.TICKETTYPE", "PM.TOTAL", "R.DATENEW", "R.DATENEW", "P.NAME", "C.NAME", "PM.NOTES"}), new SerializerWriteBasic(new Datas[]{
     ...
     * @return
     */
    public final SentenceList getProductGroupList() {
        return new StaticSentence(s, "SELECT "
                + "ID, "
                + "NAME "
                + "FROM auxiliaries_group "
                + "ORDER BY NAME", null, (DataRead dr) -> new TaxCategoryInfo(
                        dr.getString(1),
                        dr.getString(2)));
    }
    ...
    public final SentenceList getTaxCategoriesList() {
        return new StaticSentence(s, "SELECT "
                ...
                + "NAME "
                + "FROM taxcategories "
                + "ORDER BY NAME", null, (DataRead dr) -> new TaxCategoryInfo(dr.getString(1), dr.getString(2)));
    }
    ...
    public final SentenceList getAttributeSetList() {
        return new StaticSentence(s, "SELECT "
                ...
                + "NAME "
                + "FROM attributeset "
                + "ORDER BY NAME", null, (DataRead dr) -> new AttributeSetInfo(dr.getString(1), dr.getString(2)));
    }
    ...
    public final SentenceList getFloorTablesList() {
        return new StaticSentence(s, "SELECT ID, NAME, SEATS, width, height FROM places ORDER BY NAME", null, new SerializerReadClass(FloorsInfo.class));
    }
    ...
    public CustomerInfoExt findCustomerName(String name) throws BasicException {
        return (CustomerInfoExt) new PreparedSentence(s, "SELECT "
                ...
                + "ORDER BY NAME", SerializerWriteString.INSTANCE, new CustomerExtRead()).find(name);
    }
    ...
    public final TicketInfo loadTicket(final int tickettype, final int ticketid) throws BasicException {
        ...
        if (ticket != null) {
            ...
            ticket.setLines(new PreparedSentence(s, "SELECT L.TICKET, L.LINE, L.PRODUCT, L.ATTRIBUTESETINSTANCE_ID, "
                    ...
                    + "WHERE L.TAXID = T.ID AND L.TICKET = ? ORDER BY L.LINE", SerializerWriteString.INSTANCE, new SerializerReadClass(TicketLineInfo.class)).list(ticket.getId()));

            ticket.setPayments(new PreparedSentence(s, "SELECT PAYMENT, TOTAL, TRANSID, TENDERED, CARDNAME FROM payments WHERE RECEIPT = ?", SerializerWriteString.INSTANCE, new SerializerReadClass(PaymentInfoTicket.class)).list(ticket.getId()));
        }
        return ticket;
    }
    ...
    public final void saveTicket(final TicketInfo ticket, final String location) throws BasicException {
        ...
        t = new Transaction(s) {
            ...
            public Object transact() throws BasicException {
                ...
                // new ticket
                new PreparedSentence(s, "INSERT INTO tickets (ID, TICKETTYPE, TICKETID, PERSON, CUSTOMER, STATUS) "
                ...
                SentenceExec paymentinsert = new PreparedSentence(s, "INSERT INTO payments (ID, RECEIPT, PAYMENT, TOTAL, TRANSID, RETURNMSG, "
                        + "TENDERED, CARDNAME, VOUCHER, NOTES) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", SerializerWriteParams.INSTANCE);
                ...
                SentenceExec taxlinesinsert = new PreparedSentence(s, "INSERT INTO taxlines (ID, RECEIPT, TAXID, BASE, AMOUNT)  "
                        + "VALUES (?, ?, ?, ?, ?)", SerializerWriteParams.INSTANCE);
    ...
    public final boolean addGroupName(final String groupName) throws BasicException {
        System.out.print("SELECT ID, NAME FROM auxiliary_group WHERE NAME=" + groupName);

        SentenceList existing = new StaticSentence(s, "SELECT ID, NAME FROM auxiliaries_group WHERE NAME='" + groupName + "'", null, UomInfo.getSerializerRead());
        List a = existing.list();
        if (a.size() > 0) {
            return false;
        }

        SentenceExec insert;
        insert = new PreparedSentence(s, "INSERT INTO auxiliaries_group (ID, NAME)  "
                + "VALUES (?, ?)", SerializerWriteParams.INSTANCE);
        insert.exec(new DataParams() {
            @Override
            public void writeValues() throws BasicException {
    ...
    public final boolean updateGroupName(final String groupName, final String groupId) throws BasicException {
        SentenceExec updateGroup = new PreparedSentence(s, "UPDATE auxiliaries_group SET NAME=? WHERE ID=? ", SerializerWriteParams.INSTANCE);
        updateGroup.exec(new DataParams() {
            @Override
            public void writeValues() throws BasicException {
    ...
    public final void deleteGroupName(final String groupId) throws BasicException {
        SentenceExec deleteGroup = new PreparedSentence(s, "DELETE FROM auxiliaries_group WHERE ID=? ", SerializerWriteParams.INSTANCE);
        deleteGroup.exec(new DataParams() {
            @Override
            public void writeValues() throws BasicException {
                setString(1, groupId);
            }
    ...
    public final SentenceList getGroupList() {
        return new StaticSentence(s, "SELECT "
                + "ID, "
                + "NAME "
                + "FROM auxiliaries_group"
                + "ORDER BY NAME", null, UomInfo.getSerializerRead());
    }
...
// For productBundle
                    ...
                    if (bundle.size() > 0) {
                        for (ProductsBundleInfo bundleComponent : bundle) {
                            ...
                            getStockDiaryInsert().exec(new Object[]{
                                ...
                                null, ticket.getLine(i).getMultiply() * bundleComponent.getQuantity(), bundleProduct.getPriceSell(),
                                ticket.getUser().getName()});
                        }
                    }
                }
    ...
    public final SentenceFind getProductImage() {
        return new PreparedSentence(s,
                ...
                SerializerWriteString.INSTANCE, (DataRead dr) -> ImageUtils.readImage(dr.getBytes(1)));
    }
    ...
    public final SentenceExec getProductCatInsert() {
        return new SentenceExecTransaction(s) {
            ...
            public int execInTransaction(Object params) throws BasicException {
                Object[] values = (Object[]) params;//7 13
                if(values[7].equals("000"))
                    values[13] = true;
                else
                    values[13] = false;
                ...
                if (i > 0 && ((Boolean) values[30])) {
                    return new PreparedSentence(s, "INSERT INTO products_cat (PRODUCT, CATORDER) VALUES (?, ?)", new SerializerWriteBasicExt(productsRow.getDatas(), new int[]{0, 31}))
                            .exec(values);
                } else {
                    return i;
                }
            ...
            public int execInTransaction(Object params) throws BasicException {
                ...
                if (i > 0) {
                    if (((Boolean) values[30])) {
                        if (new PreparedSentence(s, "UPDATE products_cat SET CATORDER = ? WHERE PRODUCT = ?", new SerializerWriteBasicExt(productsRow.getDatas(), new int[]{31, 0})).exec(params) == 0) {
                            new PreparedSentence(s, "INSERT INTO products_cat (PRODUCT, CATORDER) VALUES (?, ?)", new SerializerWriteBasicExt(productsRow.getDatas(), new int[]{0, 31})).exec(params);
                        }
                    } else {
    ...
    public final SentenceExec getProductCatDelete() {
        return new SentenceExecTransaction(s) {
            @Override
            public int execInTransaction(Object params) throws BasicException {
                new PreparedSentence(s, "DELETE FROM product_cats WHERE SUBPRODUCT = ?", new SerializerWriteBasicExt(productsRow.getDatas(), new int[]{0})).exec(params);
                new PreparedSentence(s, "DELETE FROM products_cat WHERE PRODUCT = ?", new SerializerWriteBasicExt(productsRow.getDatas(), new int[]{0})).exec(params);
            ...
            public int execInTransaction(Object params) throws BasicException {
                ...
                int updateresult = ((Object[]) params)[5] == null
                        ? new PreparedSentence(s, "UPDATE stockcurrent SET UNITS = (UNITS + ?) "
                                ...
                                + "AND ATTRIBUTESETINSTANCE_ID IS NULL", new SerializerWriteBasicExt(stockdiaryDatas, new int[]{6, 3, 4})).exec(params)
                        : new PreparedSentence(s, "UPDATE stockcurrent SET UNITS = (UNITS + ?) "
                                + "WHERE LOCATION = ? AND PRODUCT = ? "
                                + "AND ATTRIBUTESETINSTANCE_ID = ?", new SerializerWriteBasicExt(stockdiaryDatas, new int[]{6, 3, 4, 5})).exec(params);
    ...
    public final TableDefinition getTableCategories() {
        return new TableDefinition(s,
                "categories", new String[]{"ID", "NAME", "PARENTID", "IMAGE", "TEXTTIP", "CATSHOWNAME", "CATORDER"}, new String[]{"ID", AppLocal.getIntString("label.name"), "", AppLocal.getIntString("label.image")}, new Datas[]{Datas.STRING, Datas.STRING, Datas.STRING,
                    Datas.IMAGE, Datas.STRING, Datas.BOOLEAN, Datas.STRING}, new Formats[]{Formats.STRING, Formats.STRING, Formats.STRING,
                    Formats.NULL, Formats.STRING, Formats.BOOLEAN, Formats.STRING}, new int[]{0}
        );
    }
    ...
    public final TableDefinition getTableLocations() {
        return new TableDefinition(s,
                "locations", new String[]{"ID", "NAME", "ADDRESS"}, new String[]{"ID", AppLocal.getIntString("label.locationname"),
                    AppLocal.getIntString("label.locationaddress")}, new Datas[]{Datas.STRING, Datas.STRING, Datas.STRING}, new Formats[]{Formats.STRING, Formats.STRING, Formats.STRING}, new int[]{0}
        );
    }

    public List<ProductInfoExt> getProductsByCat() {
    ...
    public final UomInfo getUomInfoById(String id) throws BasicException {
        return (UomInfo) new PreparedSentence(s,
                ...
                + "id, name "
                + "FROM uom "
                + "WHERE id = ?", SerializerWriteString.INSTANCE, UomInfo.getSerializerRead()).find(id);
    }
    ...
    public final SentenceList getVoucherList() {
        return new StaticSentence(s,
                ...
                + "FROM vouchers   "
                + "WHERE STATUS='A' "
                + "ORDER BY vouchers.VOUCHER_NUMBER ASC", null, VoucherInfo.getSerializerRead());
    }

    public final SentenceExec getVoucherNonActive() {
        return new PreparedSentence(s,
                "UPDATE vouchers SET STATUS = 'D' "
                + "WHERE VOUCHER_NUMBER = ?", SerializerWriteString.INSTANCE);
    }
    ...
    public final SentenceExec getCustomerDelete() {
        return new SentenceExecTransaction(s) {
            @Override
            public int execInTransaction(Object params) throws BasicException {
                return new PreparedSentence(s, "DELETE FROM customers WHERE ID = ?", new SerializerWriteBasicExt(customersRow.getDatas(),
                        new int[]{0}
                )).exec(params);
            }
        };
