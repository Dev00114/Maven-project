...
import com.openbravo.pos.forms.JPrincipalAppDelegate;
...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private void assignMenuButtonIcon(boolean visible) {
        jBtnMenu.setIconPrefix(visible
            ? "single-left"
            : "single-right");
    }
    /**
    ...
    private void initComponents() {
        ...
        jButton2 = new com.openbravo.beans.JImageButton();
        m_jEdit = new com.openbravo.beans.JImageButton();
        m_jRefund = new com.openbravo.beans.JImageButton();
        m_jPrint = new com.openbravo.beans.JImageButton();
        ...
        jButton1 = new com.openbravo.beans.JImageButton();
        ...
        m_jButtons.setPreferredSize(new java.awt.Dimension(555, 90));
        ...
        m_jEdit.setPreferredSize(new java.awt.Dimension(80, 80));
        ...
        m_jRefund.setIconPrefix("hand-paper");
        ...
        m_jRefund.setPreferredSize(new java.awt.Dimension(80, 80));
        ...
        m_jPrint.setPreferredSize(new java.awt.Dimension(80, 80));
        ...
        jButton1.setIconPrefix("check-56");
        jButton1.setMargin(new java.awt.Insets(8, 14, 8, 14));
        jButton1.setMaximumSize(new java.awt.Dimension(92, 92));
        ...
        m_jTicketEditor.setOpaque(false);
        ...
        jrbSales.setBackground(new java.awt.Color(30, 30, 30));
        buttonGroup1.add(jrbSales);
        jrbSales.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jrbSales.setForeground(new java.awt.Color(153, 153, 153));
        ...
        jrbSales.setOpaque(false);
        jrbSales.setRequestFocusEnabled(false);
        jPanel1.add(jrbSales);

        jrbRefunds.setBackground(new java.awt.Color(30, 30, 30));
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    private com.openbravo.beans.JImageButton jButton1;
    private com.openbravo.beans.JImageButton jButton2;
    ...
    private com.openbravo.beans.JImageButton m_jEdit;
    private com.openbravo.editor.JEditorKeys m_jKeys;
    private javax.swing.JPanel m_jOptions;
    private javax.swing.JPanel m_jPanelTicket;
    private com.openbravo.beans.JImageButton m_jPrint;
    private com.openbravo.beans.JImageButton m_jRefund;
