...
public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        m_jScrollTableTicket.getVerticalScrollBar().setPreferredSize(new Dimension(8,8));       
        ...
        m_jScrollSales.getVerticalScrollBar().setPreferredSize(new Dimension(8,8));       
...
// JG 16 May 2012 use multicatch
    ...
    private void initComponents() {
        ...
        m_jCloseCash = new com.openbravo.beans.JImageButton();
        m_jPrintCash = new com.openbravo.beans.JImageButton();
        ...
        m_jCloseCash.setFocusable(false);
        ...
        m_jCloseCash.setIconPrefix("calculator");
        ...
        m_jCloseCash.setPreferredSize(new java.awt.Dimension(80, 80));
        m_jCloseCash.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                m_jCloseCashActionPerformed(evt);
            }
        });
        jPanel1.add(m_jCloseCash, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 450, 100, -1));

        m_jPrintCash.setText(AppLocal.getIntString("button.closecash")); // NOI18N
        m_jPrintCash.setToolTipText(bundle.getString("tooltip.btn.partialcash")); // NOI18N
        m_jPrintCash.setFocusable(false);
        ...
        m_jPrintCash.setIconPrefix("print");
        ...
        m_jPrintCash.setPreferredSize(new java.awt.Dimension(80, 80));
        m_jPrintCash.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                m_jPrintCashActionPerformed(evt);
            }
        });
        jPanel1.add(m_jPrintCash, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 450, 100, -1));
    ...
    private com.openbravo.beans.JImageButton m_jCloseCash;
    ...
    private com.openbravo.beans.JImageButton m_jPrintCash;
