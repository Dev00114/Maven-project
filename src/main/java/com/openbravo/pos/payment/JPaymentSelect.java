...
// Get the size of the screen, and center the dialog in the window
    ...
    private void initComponents() {
        ...
        m_jButtonRemove = new com.openbravo.beans.JImageButton();
        m_jButtonAdd = new com.openbravo.beans.JImageButton();
        ...
        m_jButtonPrint = new com.openbravo.beans.JImageToggleButton();
        ...
        m_jButtonRemove.setIconPrefix("minus-56");
        m_jButtonRemove.setPreferredSize(new java.awt.Dimension(60, 60));
        ...
        m_jButtonAdd.setIconPrefix("plus-56");
        m_jButtonAdd.setPreferredSize(new java.awt.Dimension(60, 60));
        ...
        m_jButtonPrint.setIconPrefix("print-56");
        m_jButtonPrint.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jButtonPrint.setPreferredSize(new java.awt.Dimension(60, 60));
    ...
    private com.openbravo.beans.JImageButton m_jButtonAdd;
    private com.openbravo.beans.JImageButton m_jButtonCancel;
    private com.openbravo.beans.JImageButton m_jButtonOK;
    private com.openbravo.beans.JImageToggleButton m_jButtonPrint;
    private com.openbravo.beans.JImageButton m_jButtonRemove;
