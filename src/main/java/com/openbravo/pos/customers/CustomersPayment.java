...
public class CustomersPayment extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void activate() throws BasicException {
        ...
        this.principalApp = delegate.getApp();
...
// JG 6 May use multicatch
    ...
    private void initComponents() {
        ...
        btnSave = new com.openbravo.beans.JImageButton();
        jSeparator1 = new javax.swing.JSeparator();
        btnPay = new com.openbravo.beans.JImageButton();
        btnPrePay = new com.openbravo.beans.JImageButton();
        ...
        jPanel6.setPreferredSize(new java.awt.Dimension(608, 85));
        ...
        btnCustomer.setIconPrefix("client");
        btnCustomer.setMargin(new java.awt.Insets(8, 14, 8, 14));
        btnCustomer.setPreferredSize(new java.awt.Dimension(80, 80));
        ...
        btnPay.setIconPrefix("payment-apple");
        ...
        btnPay.setPreferredSize(new java.awt.Dimension(80, 80));
        ...
        btnPrePay.setIconPrefix("payment");
        ...
        btnPrePay.setPreferredSize(new java.awt.Dimension(80, 80));
    ...
    private void jBtnMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnMenuActionPerformed
        if(this.principalApp == null)
        {
            this.jBtnMenu.setVisible(false);
            return;
        }
        
        boolean visible = this.principalApp.jBtnMenuActionPerformed();
    ...
    private com.openbravo.beans.JImageButton btnPay;
    private com.openbravo.beans.JImageButton btnPrePay;
    private com.openbravo.beans.JImageButton btnSave;
