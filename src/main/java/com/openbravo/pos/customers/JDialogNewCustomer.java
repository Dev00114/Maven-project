...
public class JDialogNewCustomer extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        m_jBtnOK = new com.openbravo.beans.JImageButton();
        m_jBtnCancel = new com.openbravo.beans.JImageButton();
        ...
        m_jBtnOK.setIconPrefix("check-56");
        m_jBtnOK.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jBtnOK.setPreferredSize(new java.awt.Dimension(60, 60));
        ...
        m_jBtnCancel.setIconPrefix("cancel-56");
        m_jBtnCancel.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jBtnCancel.setPreferredSize(new java.awt.Dimension(60, 60));
...
private void m_jVipnone(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_m_jVipnone
    ...
    private com.openbravo.beans.JImageButton m_jBtnCancel;
    private com.openbravo.beans.JImageButton m_jBtnOK;
